namespace TicTacToe
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            // Load statistics from file when the application starts
            LoadStatistics();

            // Ask for the player's name
            playerName = Microsoft.VisualBasic.Interaction.InputBox("Enter your name:", "Welcome to Tic-Tac-Toe", "Player");

            // Greet the player by name
            welcomeLbl.Text = $"Hello, {playerName}! Let's play Tic-Tac-Toe!";

            squares = new[] { a1Btn, a2Btn, a3Btn, b1Btn, b2Btn, b3Btn, c1Btn, c2Btn, c3Btn };
        ...
        private void InitializeGame()
        {
            ...
            lblStatus.Text = isPlayerTurn
                ? $"Your turn (You are {playerMarker})"
                : $"Computer's turn (You are {playerMarker})";
        ...
        private void Square_Click(object sender, EventArgs e)
        {
            ...
            if (CheckForWinner(playerMarker))
            {
                ...
                playerWins++;
                lblWinsCount.Text = playerWins.ToString(); // Update wins count
                lblStatus.Text = $"You win {playerName}!";
                DisableAllSquares();
        ...
        {
            //New Game button will reset the board and start a new Tic Tac Toe Game
            InitializeGame();
        }
        ...
        private void LoadStatistics()
        {
            ...
            if (File.Exists(statsFilePath))
            {
                ...
                if (stats.Length == 3)
                {
                    ...
                    lblWinsCount.Text = playerWins.ToString();
                    lblLossesCount.Text = computerWins.ToString();
                    lblTiesCount.Text = ties.ToString();
                }
            }
        }
